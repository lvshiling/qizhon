	...
	<li style="border-bottom: 1px dotted #ddd; padding: 15px 0px; display: block;">
		...
		<div style="margin-left: 65px;">
			...
			<div class="tright mt05">
				<input type="hidden" class="timestamp statusIds" value="${timestamp }">
				<commons:dateformat value="${createdAt}"/>&nbsp; | &nbsp;<a href="javascript:;" onclick="getQqReply('${id }',null);">评论</a>
			</div>
			<div id="qqReplyContent_${id }" style="border: 1px solid #eee;" class="none">
				<form class="createQqCommentForm" method="post" onsubmit="return false;" action="${domain }/weibo/ajaxPostQqCommentApi.do">
...
<script type="text/javascript" >
	...
	$(function(){
		$('.createQqCommentForm').ajaxForm({	//创建回复
	        dataType:  'json', 
	        success:   function(d){
		    	if(d['status'] == 1){
		    		alertClose();
					getQqReply(d['values']['sid'],null);
