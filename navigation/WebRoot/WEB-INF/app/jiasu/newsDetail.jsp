	...
	<div id="main">
    	<div id="m_top">
        	<div id="container">
                ...
                <div class="rightside">
                	<p class="r_title"><img src="images/title_news.jpg" /></p>
                    <p class="bet"></p>
                    <div id="news">
                        <h2>${requestScope.news.title }</h2>
                        <p class="bet_dashed"></p>
                        <p style="padding: 10px;">${requestScope.news.content }</p>
                        <p class="bet_dashed"></p>
                        <br/>
                        <p class="right">趣乐</p>
                        <p class="right"><s:date name="#request.news.addTime" format="yyyy-MM-dd" /></p>
                    </div>
                  	<br/>
                    <br/>
                    <br/>
