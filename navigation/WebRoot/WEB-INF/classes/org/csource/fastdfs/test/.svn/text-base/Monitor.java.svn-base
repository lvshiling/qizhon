  		...
  		*/
  		...
  		for (StructGroupStat groupStat :  groupStats)
  		{
  			...
  			System.out.println("Group " + count + ":");
				...
				System.out.println("disk free space = " + (groupStat.getFreeMB() / 1024) + " GB");
				System.out.println("trunk free space = " + (groupStat.getTrunkFreeMB() / 1024) + " GB");
				...
				for (StructStorageStat storageStat : storageStats)
				{
					...
					System.out.println("\t\ttotal storage = " + (storageStat.getTotalMB() / 1024) + "GB");
					System.out.println("\t\tfree storage = " + (storageStat.getFreeMB() / 1024) + "GB");
