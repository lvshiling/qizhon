...
<link href="${static}/styles/jiasu/layout.css" rel="stylesheet" type="text/css" />
...
function logout(){	//登出
	$.post(Path.domain+"/user/ajaxLogoutApi.do", {}, function(d){
		if(d['status'] == 1){
			...
			window.location.href = Path.domain+"/jiasu/index.do";
...
<body>
  <div id="wrapper" class="">
  	<!-- 最外层容器，增强扩展性 -->
	<jsp:directive.include file="/commons/jiasu/header.jsp" />
	<decorator:body />
	<jsp:directive.include file="/commons/jiasu/footer.jsp" />
