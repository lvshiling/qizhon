...
<link href="${static}/styles/commons.css" rel="stylesheet" type="text/css" />
<link href="${static}/styles/layout.css" rel="stylesheet" type="text/css" />
<link href="${static}/styles/module.css" rel="stylesheet" type="text/css" />
<link href="${static}/styles/pager.css" rel="stylesheet" type="text/css" />
...
var globla_loading = '<div class="w25 mauto loading"><img src="'+Path.domain+'/images/module/loading-1.gif" width="24" height="24" /></div><p class="tcenter"></p>';
...
<body>
  <div id="wrapper" class="">
  	<!-- 最外层容器，增强扩展性 -->
	<jsp:directive.include file="/commons/header_app.jsp" />
	<decorator:body />
	<jsp:directive.include file="/commons/footer_app.jsp" />
