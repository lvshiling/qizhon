...
public class StructStorageStat extends StructBase
{
	...
	protected static final int FIELD_INDEX_TOTAL_SET_META_COUNT     = 19;
	protected static final int FIELD_INDEX_SUCCESS_SET_META_COUNT   = 20;
	protected static final int FIELD_INDEX_TOTAL_DELETE_COUNT       = 21;
	protected static final int FIELD_INDEX_SUCCESS_DELETE_COUNT     = 22;
	protected static final int FIELD_INDEX_TOTAL_DOWNLOAD_COUNT     = 23;
	protected static final int FIELD_INDEX_SUCCESS_DOWNLOAD_COUNT   = 24;
	protected static final int FIELD_INDEX_TOTAL_GET_META_COUNT     = 25;
	protected static final int FIELD_INDEX_SUCCESS_GET_META_COUNT   = 26;
	protected static final int FIELD_INDEX_TOTAL_CREATE_LINK_COUNT  = 27;
	protected static final int FIELD_INDEX_SUCCESS_CREATE_LINK_COUNT= 28;
	protected static final int FIELD_INDEX_TOTAL_DELETE_LINK_COUNT  = 29;
	protected static final int FIELD_INDEX_SUCCESS_DELETE_LINK_COUNT= 30;	
	protected static final int FIELD_INDEX_TOTAL_UPLOAD_BYTES       = 31;
	protected static final int FIELD_INDEX_SUCCESS_UPLOAD_BYTES     = 32;
	protected static final int FIELD_INDEX_TOTAL_APPEND_BYTES       = 33;
	protected static final int FIELD_INDEX_SUCCESS_APPEND_BYTES     = 34;
	protected static final int FIELD_INDEX_TOTAL_DOWNLOAD_BYTES     = 35;
	protected static final int FIELD_INDEX_SUCCESS_DOWNLOAD_BYTES   = 36;
	protected static final int FIELD_INDEX_TOTAL_SYNC_IN_BYTES      = 37;
	protected static final int FIELD_INDEX_SUCCESS_SYNC_IN_BYTES    = 38;
	protected static final int FIELD_INDEX_TOTAL_SYNC_OUT_BYTES     = 39;
	protected static final int FIELD_INDEX_SUCCESS_SYNC_OUT_BYTES   = 40;
	protected static final int FIELD_INDEX_TOTAL_FILE_OPEN_COUNT    = 41;
	protected static final int FIELD_INDEX_SUCCESS_FILE_OPEN_COUNT  = 42;
	protected static final int FIELD_INDEX_TOTAL_FILE_READ_COUNT    = 43;
	protected static final int FIELD_INDEX_SUCCESS_FILE_READ_COUNT  = 44;
	protected static final int FIELD_INDEX_TOTAL_FILE_WRITE_COUNT   = 45;
	protected static final int FIELD_INDEX_SUCCESS_FILE_WRITE_COUNT = 46;
	protected static final int FIELD_INDEX_LAST_SOURCE_UPDATE       = 47;
	protected static final int FIELD_INDEX_LAST_SYNC_UPDATE         = 48;
	protected static final int FIELD_INDEX_LAST_SYNCED_TIMESTAMP    = 49;
	protected static final int FIELD_INDEX_LAST_HEART_BEAT_TIME     = 50;
	protected static final int FIELD_INDEX_IF_TRUNK_FILE            = 51;
	
	protected static int fieldsTotalSize;
	protected static StructBase.FieldInfo[] fieldsArray = new StructBase.FieldInfo[52];
