...
*/
 public static String genSlaveFilename(String master_filename, 
                String prefix_name, String ext_name) throws Exception
 {
    ...
    {
            throw new Exception("master filename \"" + master_filename + "\" is invalid");
    }
    ...
    {
        throw new Exception("prefix_name \"" + prefix_name + "\" is invalid");
    }
