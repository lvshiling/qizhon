/**
 * ReturnQueryAdUserPartInfoByStaffNum.java
 *
...
public class ReturnQueryAdUserPartInfoByStaffNum  implements java.io.Serializable {
    private com.ztgame.webService.client.AdUserMainInfo[] user_main_info;

    public ReturnQueryAdUserPartInfoByStaffNum() {
    }
    ...
    /**
     * Gets the user_main_info value for this ReturnQueryAdUserPartInfoByStaffNum.
     * 
    ...
    /**
     * Sets the user_main_info value for this ReturnQueryAdUserPartInfoByStaffNum.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ReturnQueryAdUserPartInfoByStaffNum)) return false;
        ReturnQueryAdUserPartInfoByStaffNum other = (ReturnQueryAdUserPartInfoByStaffNum) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReturnQueryAdUserPartInfoByStaffNum.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:wsdl_passport", "ReturnQueryAdUserPartInfoByStaffNum"));
