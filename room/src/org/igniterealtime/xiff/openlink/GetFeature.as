...
{	
	...
	public class GetFeature extends IQ
	{
		...
		public function GetFeature(type:String,serverComponent:String,from:String,action:String)
		{
			this._type=type;
			this.action=action;
		...
		public function addQuery():IQ{
			...
			var iq:IQ = new IQ(new EscapedJID(serverComponent), _type);
				...
				commandNode.attributes.node = "http://xmpp.org/protocol/openlink:01:00:00#get-features";
