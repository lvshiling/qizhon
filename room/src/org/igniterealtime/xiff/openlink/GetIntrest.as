...
{	
	...
	public class GetIntrest extends IQ
	{
		...
		public function GetIntrest(type:String,serverComponent:String,from:String,action:String)
		{
			this._type=type;
			this.action=action;
		...
		public function addQuery():IQ{
			...
			var iq:IQ = new IQ(new EscapedJID(serverComponent), _type);
				...
				commandNode.attributes.node = "http://xmpp.org/protocol/openlink:01:00:00#get-interests";
