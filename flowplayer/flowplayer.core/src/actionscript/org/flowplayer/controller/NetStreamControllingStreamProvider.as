...
//                clip.setContent(null);
        ...
        private function _createNetStream():void {
			...
			log.debug("_createNetStream, clip.bufferLength: "+clip.bufferLength);
			log.debug("_createNetStream, _netStream.bufferTime: "+_netStream.bufferTime);
